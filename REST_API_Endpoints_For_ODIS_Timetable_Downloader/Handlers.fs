                ...
                {      
                    try
                        ...
                        | Ok jsonStringAsync
                            ...
                            let responseJson = response >> encoderGet >> Encode.toString indentation <| (jsonString, "Success")
                        ...
                        | Error err    
                            -> 
                            let responseJson = response >> encoderGet >> Encode.toString indentation <| (jsonEmpty, err) 
